    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/50 dark:border-slate-700/50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-slate-900/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/discord" className="hidden sm:flex items-center space-x-2 px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#5865F2] to-[#7289DA] hover:from-[#4752C4] hover:to-[#5B6EAE] rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 border border-[#4752C4]/20">
